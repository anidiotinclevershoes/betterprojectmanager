...
check("external V1 safety migration aligns project to workspace", () => {
  ...
  assert.match(safety, /project_belongs_to_workspace/);
  assert.match(safety, /delete_project_bundle/);
