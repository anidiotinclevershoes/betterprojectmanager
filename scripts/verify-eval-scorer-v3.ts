...
/**
 * Report metadata only — replay scoring does not read this SHA.
 * PR checkouts often lack origin/main (shallow fetch of the merge ref).
 */
function resolveProductionSha(): string {
  ...
  throw new Error("Could not resolve a production SHA for scorer v3 replay metadata.");
}
