...
New Project / delete are not one transaction (D-028). Same-workspace RLS is membership-wide (N-09). No production integrity observer. Paint cache is not written on Apply (N-10). Hydrate still caps Knowledge prose at 24 (D-049).
