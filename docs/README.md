...
Capture convergence diagnostic (experiment; observe-only; **do not merge the harness wholesale**): [`docs/CAPTURE_CONVERGENCE_GATE.md`](./CAPTURE_CONVERGENCE_GATE.md) — `npm run verify:capture-convergence`. Not part of ordinary `npm test`.
