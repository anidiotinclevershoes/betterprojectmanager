...
**Honest limitation on this evidence — read this before weighting section D5.** Reddit was inaccessible throughout (HTTP 403 on direct fetch), a dedicated attempt to reach community sources through other routes did not complete, and a large share of the searchable material in this niche is AI-generated affiliate SEO content rather than practitioner voice. Sources are labelled in Appendix 2 and the obvious content farms are excluded from the claims above.

**I did not find first-hand practitioner posts describing memory failure as an acute, named, emotionally charged pain.** What I found was the workaround, the reread ritual, and craft advice about note structure. Those are evidence that the *job* exists; they are not evidence that it hurts.

That distinction matters and the report should not blur it. The strongest honest statement the evidence supports is: **coaches treat between-session continuity as ordinary professional work that they manage with a text file and ten minutes of rereading.** Nobody found here describes it as a problem they are looking to solve. A product's difficulty is much higher when it must first convince someone they have a problem, and this gap in the evidence is a reason for caution independent of the competitive findings that drive the verdict in section A.
...
**Practitioner-voice evidence is the weakest part of this research, and it is a known gap rather than an oversight.** Direct fetches to `reddit.com` returned HTTP 403 throughout. A dedicated research task aimed at alternative routes into community discussion — subreddit mirrors, `site:` search, coaching Facebook groups, LinkedIn, podcasts, and the negative reviews on G2 and Capterra — **failed to complete and returned no findings.** What remains is coaching craft writing by named practising coaches, professional-body publications, and search snippets.

The practical consequence: section D5's quotations are genuine and useful, but they are drawn from *published craft writing*, which is a self-selecting and somewhat idealised source. Coaches who write publicly about note-taking method are not a random sample of coaches. **The absence of first-hand practitioner posts describing memory failure as an acute pain is treated as evidence in section D5 rather than papered over**, but it should be understood as *absence of evidence gathered under difficult conditions*, not as *evidence of absence*.

If this investigation is revisited, closing this gap is the cheapest remaining improvement — and section W0 (two hours on a competitor's free tier) plus twenty recorded conversations with real coaches would settle both this and the willingness-to-pay question far more decisively than any further desk research.
