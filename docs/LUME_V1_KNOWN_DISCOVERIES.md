...
**Last housekeeping:** 12 September 2026 (D-052 New Project Organise name-only people recovery reconstructed on post-holdout main; D-051 identity evidence is observation-local; D-050 hosted schema catch-up; D-049 hydrate completeness)  
...
| --- | --- |
| **Status** | fixed |
| **Fixed in** | reconstructed on `cursor/capture-convergence-reconstruct-73de` after holdout merge `#164` |
| **Severity** | high |
